...
static inline void Read(int fd, void* _buf, size_t count) {
    char* buf = (char*) _buf;
    while (1) {
...
static inline void Write(int fd, const void* _buf, size_t count) {
    char* buf = (char*) _buf;
    while (1) {
...
static inline void Send(int sockfd, const void* _buf, size_t len, int flags) {
